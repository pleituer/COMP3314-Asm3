...
![LDP Feature extraction result](./lbp_plot.png)

We may notice that the accuracy of our LBP model is at around ($31\%\sim 33%$), which is much lower than the HOG-based model. Furthermore,even after concatinating the LBP features to our training data and running SVM, we have only obtained an accuracy of $35.8%$.
...
![LDP Feature extraction result](./lbp_extraction.png)
